# FarmShare collaborator 1 — seed 1

This kit owns exactly five protected 160M jobs: Dense/Split at `n50k`, and
Dense/Split/Random at `n800k`, all with model seed 1 and data seed 10001.
...
export DATA_ROOT="/scratch/users/$USER/relational-data-seed1"
export OUT_ROOT="/scratch/users/$USER/relational-runs-seed1"
...
for data_rel in n50k_ds10001 n800k_ds10001; do
